...
class Coordinator():
    ...
    def get_environment_config(self) -> Config:
        ...
        if (len(args) >= 4):
            ...
            actor_pretrained_weights_path = '/home/naposto/phd/nokia/agents/model/ddpg_actor_weights_snr_custom_multiprb_extended_favor_.5.h5'
            critic_pretrained_weights_path = '/home/naposto/phd/nokia/agents/model/ddpg_critic_weights_snr_custom_multiprb_extended_favor_.5.h5'
